...
ad_proc -public im_translation_create_purchase_orders {
    ...
    db_foreach task_tasks $task_sql {
        ...
        set po_created_p [db_string po_created "select i.invoice_id from im_invoice_items ii, im_invoices i where task_id = :task_id and company_contact_id = :freelance_id limit 1" -default 0]
        ds_comment "Freelancer :: $freelance_id :: $po_created_p"
        if {!$po_created_p} {
